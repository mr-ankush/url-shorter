...
public class facebook_short extends HttpServlet 
{
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        try 
        {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Generate Facebook URL</title>");
            ...
            String long_url="", short_url="", date="", url_date="", url_time="",
            ...
            long_url = "https://www.facebook.com/sharer/sharer.php?u="+long_url;
            //out.println(url+"<br>");
            ...
            {
                if(url_type.equals("Facebook Link"))
                {
    ...
    //                            "Don't refresh page otherwise shorted URL may be changed.");
                            ...
                            response.sendRedirect("http://www.urllive.in:8084/UrlLive/facebook/api/");
                        }
                        else
                        {
...
//                session.setAttribute("short_url",short_url);
        ...
        {
            Logger.getLogger(facebook_short.class.getName()).log(Level.SEVERE, null, e);
        }
    }
}