...
public class email_short extends HttpServlet 
{
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        try 
        {
            ...
            Coder Co = null;
            Co = cod.encode(request.getParameter("body"));
            body = Co.getEncode();            
            //out.println(body+"<br>");
            long_url = "mailto:"+to;
            ...
            {
                long_url = "mailto:"+to+"?cc="+cc+"&bcc="+bcc;
            }
            out.println(long_url+"<br>");
            if(subject.isEmpty())
            {
            ...
            {
                long_url = "mailto:"+to+"?cc="+cc+"&bcc="+bcc+"&subject="+subject;
            }
            out.println(long_url+"<br>");
            if(body.isEmpty())
            {
            ...
            {
                long_url = "mailto:"+to+"?cc="+cc+"&bcc="+bcc+"&subject="+subject+"&body="+body;
            }
            //out.println(long_url+"<br>");
    ...
    //                            "Don't refresh page otherwise shorted URL may be changed.");
                            ...
                            response.sendRedirect("http://www.urllive.in:8084/UrlLive/email/api/");
                        }
                        else
                        {
...
//                session.setAttribute("short_url",short_url);
        ...
        {
            Logger.getLogger(email_short.class.getName()).log(Level.SEVERE, null, e);
        }
    }
}