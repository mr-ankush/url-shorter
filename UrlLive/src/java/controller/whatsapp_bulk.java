...
public class whatsapp_bulk extends HttpServlet 
{
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        try 
        {
            ...
            String url_msg="", url_link="", long_url="", short_url="", date="",
                    url_date="", url_time="", url_os="", url_browser="",
                    url_ip_add="", url_type="", url_city="", url_country="",
                    url_region="", url_postal="", url_location="";
            ...
            if(url_link.isEmpty())
            {
                long_url = "https://api.whatsapp.com/send?text="+url_msg+"&app_absent=true";
            }
            else
            {
                long_url = "https://api.whatsapp.com/send?text="+url_msg+"%0A%0A*"+url_link+"*&app_absent=true";
            }
            ...
            {
                if(url_type.equals("Whatsapp Bulk Message"))
                {
