                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                 <div class="input-group">
                                                    <big style="font-size:25px;color:deeppink;"><b><%= msg %></b></big>
                                                </div>
                                            </div>
                                            <br>
                                            <div class="col-md-2 text-right">
                                                <a href="<%= url %>" target="_blank">
                                                    <button type="button" class="btn btn-warning btn-wd">Test Malicious URL Preview&nbsp;<i class="fa fa-eye"></i></button>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12 text-left">
                                                <br><br>
                                                <big><b>Track <a class="text-info" href="http://www.urllive.in:8084/UrlLive/url/clicks/">the total of clicks</a> in real-time from your shortened URL.</b></big>
                                                <br><br>
                                                <big><b>Report other <a class="text-info" href="http://www.urllive.in:8084/UrlLive/report-malicious/">shortened URL</a>.</b></big>
                                            </div>
                                        </div>
