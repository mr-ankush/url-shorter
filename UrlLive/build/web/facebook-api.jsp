...
<head>
    ...
    <title>Generate Facebook URL</title>
			...
			<nav class="navbar navbar-default">
	            <div class="container-fluid">
	                <div class="navbar-header">
	                    ...
	                    <a class="navbar-brand">Facebook API / URL</a>
	                </div>
	        ...
	        <div class="content">
	            <div class="container-fluid">
	                <div class="row">
	                        ...
	                        <div class="card">
	                            <div class="header">
                                        <h2 class="title"><b>Facebook Link Generator</b></h2>
	                            </div>
	                            <div class="content">
	                                <form action="http://www.urllive.in:8084/UrlLive/facebook_short" method="POST">
	                                    <div class="row">
	                                        <div class="col-lg-2 col-md-2">
	                                            ...
	                                            <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="type" id="type" readonly value="Facebook Link">
