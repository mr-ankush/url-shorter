...
<head>
    ...
    <title>Report Malicious URL</title>
			...
			<nav class="navbar navbar-default">
	            <div class="container-fluid">
	                <div class="navbar-header">
	                    ...
	                    <a class="navbar-brand">Report URL</a>
	                </div>
	            ...
	            <div class="container-fluid">
	                <div class="row">
	                	<div class="col-lg-12 col-md-12">
	                        <div class="card">
	                            <div class="header">
                                        <h2 class="title"><b>Report Malicious Short Link</b></h2>
                                        <br>
                                        <label>Use the form below to report URLs that are distributing <b>spam</b> & <b>malware</b>. Help us by sending links that are against our terms of use, we will delete and block these shortened links. If spammers are sending you e-mails containing our shortened URLs, tell us and we can take quick action to avoid the distribution of inappropriate links.</label>
	                            </div>
	                            <div class="content">
	                                <form action="http://www.urllive.in:8084/UrlLive/report_url" method="POST">
	                                    <div class="row">
	                                        <div class="col-md-12">
	                                            <div class="form-group">
                                                        <label>Malicious URL</label>
                                                        <input type="url" name="url" id="url" class="form-control border-input" placeholder="http://www.urllive.in:8084/UrlLive/abcdef" required autocomplete="off">
                                                        <input type="hidden" name="ip" id="ip" readonly>
	                                            </div>
	                                            <div class="form-group">
                                                        <label>Comment</label>
                                                        <input class="form-control border-input" list="v_msg" name="comment" placeholder="Share your experience / feedback" spellcheck="true" required autocomplete="off" maxlength="250">
                                                            <datalist id="v_msg" style="display:none">
                                                             <option value="This URL contains virus.">This URL contains virus.</option>
                                                             <option value="This URL contains malware.">This URL contains malware.</option>
                                                             <option value="This URL contains Spamming.">This URL contains Spamming.</option>
                                                             <option value="This URL is not safe for under age.">This URL is not safe for under age.</option>
                                                             <option value="This URL contains unwanted data.">This URL contains unwanted data.</option>
                                                             <option value="This URL contains too much ads.">This URL contains too much ads.</option>
                                                             <option value="This URL is not safe.">This URL is not safe.</option>
                                                             <option value="This URL may hacked user's data.">This URL may hacked user's data.</option>
                                                            </datalist>                                                        
	                                            </div>
	                                        </div>
                                                <div class="col-md-2 text-left">
                                                    <big class="text-left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b id='sum'></b> = <input onfocus="this.value=''; disable();" onkeyup="checkSum();" class="text-center" id='result' type='text'size='2' maxlength="2" required autocomplete="off" style="width:50px"></big>&nbsp;&nbsp;&nbsp;<i onclick='change();' style="cursor:pointer" class="rotate fa fa-refresh"></i>
                                                    <style>
                                                        .rotate{
                                                            color:darkgray;
                                                            -ms-transition: 0.4s ease-in-out;
                                                            -mwebkit-transition: 0.4s ease-in-out;
	                                        ...
	                                        <div class="col-md-2 text-right">
                                                    <button type="submit" id='submit' class="btn btn-danger btn-fill btn-wd">Report URL&nbsp;<i class="fa fa-link"></i></button>
	                                    	</div>
                                                <script>
	        ...
	        <footer class="footer">
	            <div class="container-fluid">
	                <nav class="pull-left">
	                    <ul>
                                <li>
                                    <a href="http://www.urllive.in:8084/UrlLive/report-malicious/"><b><i class="ti-receipt"></i> Report Malicious URL</b></a>
	                        </li>
	                    </ul>
	                </nav>
