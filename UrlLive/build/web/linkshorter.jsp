			...
			<nav class="navbar navbar-default">
	            <div class="container-fluid">
	                <div class="navbar-header">
	                    ...
	                    <a class="navbar-brand">URL Shorter</a>
	                </div>
	                	...
	                	<div class="col-lg-12 col-md-12">
	                        <div class="card">
	                            ...
	                            <div class="content">
	                                ...
	                                <form action="http://www.urllive.in:8084/UrlLive/url_short" method="POST">
	                                    <div class="row">
	                                        <div class="col-md-12">
	                                            <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="type" id="type" readonly value="Link Shortering">
	                                        ...
	                                        <div class="col-md-2 text-right">
                                                    <button type="submit" class="btn btn-danger btn-fill btn-wd">Short URL&nbsp;<i class="fa fa-link"></i></button>
	                                    	</div>
