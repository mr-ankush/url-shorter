...
<head>
    ...
    <title>Custom URL Shorter</title>
			...
			<nav class="navbar navbar-default">
	            <div class="container-fluid">
	                <div class="navbar-header">
	                    ...
	                    <a class="navbar-brand">Custom URL Shorter</a>
	                </div>
	            ...
	            <div class="container-fluid">
	                <div class="row">
	                	<div class="col-lg-12 col-md-12">
	                        <div class="card">
	                            <div class="header">
                                        <h2 class="title"><b>Paste the URL to be shortened</b></h2>
	                            </div>
	                            <div class="content">
                                        <label>Enter the link here</label>
	                                <form action="http://www.urllive.in:8084/UrlLive/custom_short" method="POST">
	                                    <div class="row">
	                                        <div class="col-md-12">
	                                            <div class="form-group">
                                                        <input type="url" name="url" id="url" class="form-control border-input" placeholder="https://www.example.com/page/" required autocomplete="off">
                                                        <input type="hidden" name="type" id="type" readonly value="Custom URL">
	                                        ...
	                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <div class="form-group" style="font-size:20px;">
                                                        <big>
                                                        <span style="cursor:pointer;" class="btn-fill btn-info btn-lg badge">http://www.urllive.in:8084/UrlLive</span>
                                                        <b>/
                                                            <input type="text" name="keyword" id="keyword" class="border-input text-center" placeholder="URL Keyword" title="Field is Case Sensitive." required autocomplete="off" maxlength="20" style="width:250px;border-color:transparent;border-bottom-color:black;color:darkslateblue;">
                                                        /</b>
                                                        <span onclick="alert('The last four characters will be auto-generated by the software.');" style="cursor:pointer;" class="btn-fill btn-info btn-lg badge" title="The last four characters will be autogenerated by the software">@@@@</span>
                                                        </big>
	                                            </div>
                                                    <span style="cursor:pointer;" class="btn-default btn-fill badge">Custom URL limit must be less than or equal to 20 characters.</span>
                                                    <span style="cursor:pointer;" class="btn-default btn-fill badge">The last four characters will be autogenerated by the software</span>
                                                </div>    
                                            </div>
                                            <br><br>
                                            <div class="row">
	                                        <div class="col-md-2 text-right">
                                                    <button type="submit" class="btn btn-danger btn-fill btn-wd">Generate Custom URL&nbsp;<i class="fa fa-link"></i></button>
	                                    	</div>
