	        ...
	        <div class="content">
	            <div class="container-fluid">
	                <div class="row">
	                        ...
	                        <div class="card">
	                            <div class="header">
                                        <h2 class="title"><b>Linked-In Link Generator</b></h2>
	                            </div>
	                            <div class="content">
	                                <form action="http://www.urllive.in:8084/UrlLive/linkedin_short" method="POST">
	                                    <div class="row">
	                                        <div class="col-lg-2 col-md-2">
	                                            ...
	                                            <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="type" id="type" readonly value="Linkedin Link">
	                                        ...
	                                        <div class="col-lg-2 col-md-2">
                                                ...
                                                <div class="col-lg-10 col-md-10">
	                                            <div class="form-group">
                                                        <input type="text" name="title" id="title" class="form-control border-input" placeholder="TITLE HERE" autocomplete="off" maxlength="200">
                                                        <span style="cursor:pointer;" class="btn-default btn-fill badge">OPTIONAL: Title of Message</span>
	                                            </div>
	                                        </div>
	                                    </div>
                                            <div class="row">
	                                        <div class="col-lg-2 col-md-2">
                                                ...
                                                <div class="col-lg-10 col-md-10">
	                                            <div class="form-group">
                                                        <textarea name="summary" rows="5" class="form-control border-input" placeholder="Enter default message..." spellcheck="true"></textarea>
                                                        <span style="cursor:pointer;" class="btn-default btn-fill badge">OPTIONAL: Description of Message</span>
	                                            </div>
	                                        </div>
	                                    </div>
                                            <div class="row">
	                                        <div class="col-lg-2 col-md-2">
                                                ...
                                                <div class="col-lg-10 col-md-10">
	                                            <div class="form-group">
                                                        <input type="text" name="source" id="source" class="form-control border-input" placeholder="Source or Website Name" autocomplete="off" maxlength="200">
                                                        <span style="cursor:pointer;" class="btn-default btn-fill badge">OPTIONAL: Source of the content (e.g. your website or application name)</span>
	                                            </div>
	                                        </div>
	                                    </div>
                                            <div class="row">
