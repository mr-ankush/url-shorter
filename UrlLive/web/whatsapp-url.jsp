<%@page import="model.Coder"%>
<%@page import="dao.CoderDAO"%>
<%@page import="dao.UrlDAO"%>
<%@page import="model.Url"%>
<%
UrlDAO ud = new UrlDAO();
Url U;
String short_url,url_msg,url_link;
short_url = session.getAttribute("short_url").toString();
url_msg = session.getAttribute("url_msg").toString();
CoderDAO cod = new CoderDAO();
Coder Co = null;
Co = cod.decode(url_msg);
url_msg = Co.getDecode();
url_link = session.getAttribute("url_link").toString();
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-left">
                                                ...
                                                <div class="col-md-2 text-left">
                                                    <big><b>Default Message:</b></big>
                                                </div>
                                                <div class="col-md-10 text-left">
                                                    <big><b><a class="text-info"><%= url_msg %><br><%= url_link %></a></b></big>
                                                </div>
                                                <!--<big><b>Default Message: <a class="text-info"></a></b></big>-->
                                                <br><br><br><br>
                                                ...
                                                <br><br>
                                                <big><b>Create other <a class="text-info" href="http://www.urllive.in:8084/UrlLive/whatsapp/api">shortened URL</a>.</b></big>
                                            </div>
                                        </div>
