...
<head>
    ...
    <title>Generate Email URL</title>
			...
			<nav class="navbar navbar-default">
	            <div class="container-fluid">
	                <div class="navbar-header">
	                    ...
	                    <a class="navbar-brand">Email API / URL</a>
	                </div>
	        ...
	        <div class="content">
	            <div class="container-fluid">
	                <div class="row">
	                        ...
	                        <div class="card">
	                            <div class="header">
                                        <h2 class="title"><b>Email Link Generator</b></h2>
	                            </div>
	                            <div class="content">
	                                <form action="http://www.urllive.in:8084/UrlLive/email_short" method="POST">
	                                    <div class="row">
	                                        <div class="col-lg-2 col-md-2">
	                                            ...
	                                            <div class="form-group">
                                                        <input type="text" name="to" id="to" class="form-control border-input" placeholder="name@email.com" required autocomplete="off">
                                                        <span style="cursor:pointer;" class="btn-default btn-fill badge">E-mail Recipient Address</span>
                                                        <span style="cursor:pointer;" class="btn-default btn-fill badge">Also select more than 1 recipient address</span>
                                                        <span style="cursor:pointer;" class="btn-default btn-fill badge">E-mail Address separated by ; (semicolon) or , (comma)</span>
                                                        <input type="hidden" name="type" id="type" readonly value="Email Link">
                                                        <input type="hidden" name="os" id="os" readonly>
                                                        <input type="hidden" name="browser" id="browser" readonly>
                                                        <input type="hidden" name="city" id="city" readonly>
                                                        <input type="hidden" name="country" id="country" readonly>
                                                        <input type="hidden" name="region" id="region" readonly>
                                                        <input type="hidden" name="location" id="loc" readonly>
                                                        <input type="hidden" name="postal" id="postal" readonly>
                                                        <input type="hidden" name="ip" id="ip" readonly>
	                                            </div>
	                                        </div>
	                                    </div>
                                            <div class="row">
	                                        <div class="col-lg-2 col-md-2">
                                                ...
                                                <div class="col-lg-10 col-md-10">
	                                            <div class="form-group">
                                                        <input type="text" name="cc" id="cc" class="form-control border-input" placeholder="name1@email.com; name2@email.com; name3@email.com;" autocomplete="nope">
                                                        <span style="cursor:pointer;" class="btn-default btn-fill badge">Carbon Copy E-mail Address</span>
                                                        <span style="cursor:pointer;" class="btn-default btn-fill badge">Also select more than 1 recipient address</span>
                                                        <span style="cursor:pointer;" class="btn-default btn-fill badge">E-mail Address separated by ; (semicolon) or , (comma)</span>
	                                            </div>
	                                        </div>
	                                        ...
	                                        <div class="col-lg-2 col-md-2">
                                                ...
                                                <div class="col-lg-10 col-md-10">
	                                            <div class="form-group">
                                                        <input type="text" name="bcc" id="bcc" class="form-control border-input" placeholder="name1@email.com; name2@email.com; name3@email.com;" autocomplete="nope">
                                                        <span style="cursor:pointer;" class="btn-default btn-fill badge">Blind Carbon Copy E-mail Address</span>
                                                        <span style="cursor:pointer;" class="btn-default btn-fill badge">Also select more than 1 recipient address</span>
                                                        <span style="cursor:pointer;" class="btn-default btn-fill badge">E-mail Address separated by ; (semicolon) or , (comma)</span>
	                                            </div>
	                                        </div>
	                                        ...
	                                        <div class="col-lg-2 col-md-2">
                                                ...
                                                <div class="col-lg-10 col-md-10">
	                                            <div class="form-group">
                                                        <input type="text" name="subject" id="subject" class="form-control border-input" placeholder="SUBJECT" autocomplete="off" spellcheck="true" maxlength="30">
                                                        <span style="cursor:pointer;" class="btn-default btn-fill badge">Subject of e-mail</span>
	                                            </div>
	                                        </div>
	                                    </div>
                                            <div class="row">
	                                        <div class="col-lg-2 col-md-2">
                                                ...
                                                <div class="col-lg-10 col-md-10">
	                                            <div class="form-group">
                                                        <textarea name="body" rows="5" class="form-control border-input" placeholder="Enter default message..." spellcheck="true"></textarea>
                                                        <span style="cursor:pointer;" class="btn-default btn-fill badge">Body of e-mail</span>
                                                        <span style="cursor:pointer;" class="btn-default btn-fill badge">Don't paste link in body section</span>
	                                            </div>
	                                        </div>
	                                    </div>
                                            <div class="row">
	                                        <div class="col-md-2 text-right">
                                                    <button type="submit" class="btn btn-default btn-wd">Generate Link&nbsp;<i class="fa fa-link"></i></button>
                                                </div>
	                                    </div>
                                            <div class="col-md-12 text-center">
                                                <big><b>UrlLive.in is a free tool to shorten a URL or reduce a link.<br>Use our URL Shortener to create a shortened link making it easy to remember.</b></big>
                                            </div>
...
(function () {
    ...
    document.getElementById('os').value = e.os.name;
    document.getElementById('browser').value = e.browser.name;
}());
</script>
<script>
    var ipinfo;
