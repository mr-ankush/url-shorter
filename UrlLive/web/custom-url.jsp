	                            ...
	                            <div class="content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-left">
                                                <br><br>
                                                <big><b>Long URL: <a class="text-info" target="_blank" href="<%= U.getLong_url() %>"><%= U.getLong_url() %></a></b></big>
                                                <br><br><br><br>
                                                ...
                                                <br><br>
                                                <big><b>Create other <a class="text-info" href="http://www.urllive.in:8084/UrlLive/url/custom">shortened URL</a>.</b></big>
                                            </div>
                                        </div>
