...
<head>
    ...
    <title>Generate Twitter URL</title>
			...
			<nav class="navbar navbar-default">
	            <div class="container-fluid">
	                <div class="navbar-header">
	                    ...
	                    <a class="navbar-brand">Twitter API / URL</a>
	                </div>
	                            ...
	                            <div class="content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-left">
                                                ...
                                                <br><br>
                                                <big><b>Create other <a class="text-info" href="http://www.urllive.in:8084/UrlLive/twitter/api">shortened URL</a>.</b></big>
                                            </div>
                                        </div>
